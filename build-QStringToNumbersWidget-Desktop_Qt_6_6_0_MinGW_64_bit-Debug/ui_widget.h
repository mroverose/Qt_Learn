...
public:
    ...
    QLabel *label_3;
    QLineEdit *lineEdit_sumPrice;
    QHBoxLayout *horizontalLayout_4;
    QPushButton *pushButton_qDebugTest;
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        lineEdit_sumPrice = new QLineEdit(groupBox);
        lineEdit_sumPrice->setObjectName("lineEdit_sumPrice");

        horizontalLayout_3->addWidget(lineEdit_sumPrice);
        ...
        horizontalLayout_4->setContentsMargins(2, -1, 4, -1);
        pushButton_qDebugTest = new QPushButton(groupBox);
        pushButton_qDebugTest->setObjectName("pushButton_qDebugTest");

        horizontalLayout_4->addWidget(pushButton_qDebugTest);
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        pushButton_qDebugTest->setText(QCoreApplication::translate("Widget", "qDebug()\346\265\213\350\257\225", nullptr));
