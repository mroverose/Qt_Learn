...
void MainWindow::paintEvent(QPaintEvent *event){
    ...
    painter.drawPixmap(0,ui->toolBar->height(),this->width(),this->height() -ui->toolBar->height() - ui->statusbar->height(),
                       QPixmap(":/new/prefix1/background1.jpg"));
    event->accept();
}
...
void MainWindow::on_action_BuildInWidget_triggered()
{
...
void MainWindow::on_action_StandWidget_triggered()
{
    ...
    formDoc->setWindowOpacity(0.8);               //透明度
...
void MainWindow::on_action_BuildInMainWindow_triggered()
{
...
void MainWindow::on_action_StandMainWindow_triggered()
{
    TFormTable *formTable = new TFormTable(this);
